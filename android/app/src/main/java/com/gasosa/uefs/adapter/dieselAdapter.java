...
public class dieselAdapter extends RecyclerView.Adapter<dieselAdapter.MyViewHolder> {
    ...
    public dieselAdapter(List<Posto> l, Context c) {
        this.listaPosto = l;
        this.context = c;
    }
    @NonNull
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemLista = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adpter_diesel, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.adddiesel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public MyViewHolder(@NonNull View itemView) {
        super(itemView);
        nome=itemView.findViewById(R.id.TituloViewDi);
        alcool= itemView.findViewById(R.id.gasolinaViewDi);
        data= itemView.findViewById(R.id.dataviewDi);
        bairro= itemView.findViewById(R.id.bairroViewDi);
        button= itemView.findViewById(R.id.buttonLinkDi);
