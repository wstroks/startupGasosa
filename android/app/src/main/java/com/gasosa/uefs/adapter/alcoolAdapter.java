...
public class alcoolAdapter extends RecyclerView.Adapter<alcoolAdapter.MyViewHolder>{
    ...
    public alcoolAdapter(List<Posto> l, Context c) {
        this.listaPosto = l;
        this.context = c;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemLista = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adapter_alcool, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.addAlcool.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public  class MyViewHolder  extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            alcool= itemView.findViewById(R.id.dieselAdBuscar);
