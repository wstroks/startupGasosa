...
public class dieselAditivadoAdapter extends RecyclerView.Adapter<dieselAditivadoAdapter.MyViewHolder> {
    ...
    public dieselAditivadoAdapter(List<Posto> l, Context c) {
        this.listaPosto = l;
        this.context = c;
    }
    @NonNull
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemLista = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.diesel_aditivo_dapter, viewGroup, false);
    ...
    public  class MyViewHolder  extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            nome=itemView.findViewById(R.id.TituloViewDiA);
            alcool= itemView.findViewById(R.id.gasolinaViewDiA);
            data= itemView.findViewById(R.id.dataviewDiA);
            bairro= itemView.findViewById(R.id.bairroViewDiA);
            button= itemView.findViewById(R.id.buttonLinkDiA);
